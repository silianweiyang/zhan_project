            ...
            $("#" + parentIds).find("#submit").click(function () {
                if (verification()) {
                    ...
                    if( $("#divModel").val() == "update"){
                        common.ajaxPost("dsDataSource/updateDataSource",_param,alertFun,null,false,null);
                    }else if($("#divModel").val() == "add"){
                        common.ajaxPost("dsDataSource/addDataSource", _param,alertFun, null, false, null);
                    }
                }
            });
        }
