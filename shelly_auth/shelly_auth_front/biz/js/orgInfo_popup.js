    ...
    var orgTreeview = function (root) {
        ...
        this.orgInfo_popup_queryOrgBtn = function () {
            $("#" + root).find("#orgInfo_popup_queryOrg").on("click", function () {
                ...
                common.ajaxGet("stateOrg/queryGradeOrgTree", params, successFun, errorFun, null, $("#orgInfoMgr_leftTree"));
        ...
        this.onSelect = function (dataItem) {
            ...
            var selected = {"orgCode": dataItem.orgCode, "orgName": dataItem.orgName};
        ...
        this.queryData = function (id, fun) {
            ...
            common.ajaxGet("stateOrg/queryGradeOrgTree", params, querySuccessFun, queryErrorFun, null, $("#orgInfoMgr_leftTree"));
        };
        this.init = function () {
            ...
            option["onSelect"] = this.onSelect;
            option["queryData"] = this.queryData;
            option["queryKey"] = "orgCode";
            option["initParam"] = "";
